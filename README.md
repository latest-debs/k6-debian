![k6 for Debian](.github/readme-header.png)

# k6 for Debian

[grafana/k6](https://github.com/grafana/k6) — A modern load-testing tool for testing the performance and reliability of APIs and services, scriptable in JavaScript. —
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/k6-debian/releases) page:
...
- amd64, arm64, armhf, i386, ppc64el, riscv64, s390x — whichever
  architectures grafana/k6 actually publishes a Linux binary for
